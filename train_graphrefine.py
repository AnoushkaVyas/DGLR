...
along with the soil moisture prediction module.
...
for itr in range(args.noftimes):
    ...
    for epoch in range(args.epochs):
        ...
        for i in range(args.nofstations):
            ...
            loss_train=loss_train+loss_wd.item()+loss_refine_wd.item()
            loss_pred=loss_pred+loss_wd.item()
            loss_graph_refine=loss_graph_refine+loss_refine_wd.item()
            
            loss_total=gamma * loss_wd+ delta* loss_refine_wd 
            loss_total.backward()
