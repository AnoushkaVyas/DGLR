...
def load_data_alabama(dataset="Alabama"):
    """Load Alabama dataset"""
    ...
    # build adjacency
    path_for_edge="./Datasets/Alabama/graph/edges.txt"
    ...
    #features and ID
    path_for_feature="./Datasets/Alabama/features/"
    features=[]
    AList=[]
    date=[]
    ...
    #soilmoisture
    path_for_SM="./Datasets/Alabama/groundtruth_SM/"
    SM=[]
